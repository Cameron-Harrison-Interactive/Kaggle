...
def plan_market(S, day):
    ...
    # ---- WHEAT FILL: 1 op/day/tile — the only filler the crew-10 op budget
    # can absorb. Bounded: last profitable sow d26 (harvest d+2..d+4) ----
    if 10 <= day <= 26 and len(S["quadrants"]) >= 3 and pxw >= 30:
