...
def agent(obs, config=None):
    ...
    if (1 <= day <= 20 and n_cows < TARGET_COWS and money > 900
    ...
    for i in range(n_units):
        ...
        if act is None:
            ...
            if weed_cand:
                ...
                day_cap = 20 if (strb_tiles < 20 and day <= 12) else (16 if wheat_short else 13)
                if (len(plants_all) < p_max and planted_today < day_cap
                        and _dist_to_shed(*empty_tiles[0]) <= 9.5):
                    ...
                    if cand:
                        ...
                        if (seeds.get("MELON", 0) > 0 and 1 <= day <= 5
                                and melon_tiles < 12):
                            crop = "MELON"
                        elif (seeds.get("STRAWBERRY", 0) > 0 and 2 <= day <= 12
                                and strb_tiles < 33
                                and wheat_tiles >= 6):
                            crop = "STRAWBERRY"
