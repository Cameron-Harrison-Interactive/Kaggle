...
def agent(obs, config=None):
    ...
    # v45: route machinery removed (falsified); greedy + sectors + locks
    # (proven) + late-day urgent interrupts (unfed animals h>=16, danger
    # water h>=18 -> nearest unit diverts). Daily reset means h0 planning
    # sees zero hands; greedy handles the whole day adaptively.
