...
# ---------------------------------------------------------------------------
# v25 market layer (minimal, twin-safe). v24 falsified 7W-13W vs verbatim
# router: front-running MILK/WOOL dumps added supply that floored the market
# for our own tape's remaining volume (milk cliff = 77u total; both twins
# produce ~140u each; the tape already dribbles milk 54-61x/game).
# Surviving rules are strictly non-negative:
#   - eggs cleared (uncrashable; tape clears them but slowly)
#   - STRB only at true strength ($180+) - the tape dribbles 42x/game, so
#     this fires rarely and only into real premium
#   - MELON $220+, CARROT $40+ strength-only
#   - NO milk trigger, NO wool trigger, NO panic floor
#   - shed-cap guard (no-drop law) and endgame full liquidation
# ---------------------------------------------------------------------------

_TT_AGENT = agent
_TRIG = {"STRAWBERRY": 180, "MELON": 220, "CARROT": 40}
_EGG_CLEAR = 4
