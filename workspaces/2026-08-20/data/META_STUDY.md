...
## 2026-08-09 — HealthStone #1 (team 16672202) ×5

See `data/healthstone/HS_STUDY.md`. Summary: sheep-first open, land d6/d10, straw+melon
no tomato, peaks $155k. v15 AdaptivePortfolio beats extracted HS tapes 10/10 seat
matchups seed1–5. Full tom-melon counter-tape **rejected** (loses vs 14.5, −$50k abs).

## 2026-08-09 — Seb #2 (team 16630516) ×5

See `data/seb/SEB_STUDY.md`. 4-quad animal-heavy, wheat net-buyer, straw sells 289–323,
peaks $183k. v15 beats extracted Seb tapes 10/10 seeds 1–5 (tape fragile locally).
