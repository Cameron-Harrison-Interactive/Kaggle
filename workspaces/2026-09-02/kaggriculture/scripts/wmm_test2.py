...
solo = [round(game(agent, lambda o, c=None: {"farmer": ["PASS"], "hands": [], "market": []}, s)[0]) for s in (3, 4, 5, 19, 20)]
mir = [game(agent, stock, s) for s in (3, 4, 19, 29, 5)]
...
jobs = [
    ('W3 batch60 (extended)', {'wheat_market_maker': True, 'wheat_minimum_profit': 1.0, 'wheat_batch': 60}),
    ('W6 batch120', {'wheat_market_maker': True, 'wheat_minimum_profit': 1.0, 'wheat_batch': 120}),
    ('W7 batch200', {'wheat_market_maker': True, 'wheat_minimum_profit': 1.0, 'wheat_batch': 200}),
    ('W8 profit0.5 batch120', {'wheat_market_maker': True, 'wheat_minimum_profit': 0.5, 'wheat_batch': 120}),
]
...
print('(stock refs: solo s3/s4/s5=188863/152001/165520; mirror deltas >0 = variant beats stock)')
