"""
v32_champion.py  (2026-09-16)  --  R69: SW packed crop walk + NE packed walk + fert.

Built from war/astra_live20_41.py (KEEP). Lineage:
  v30 posted [56262741]
  R62 NW scripted animal route (live20_34)
  R63 NE leftover-wheat + 4 holes + 4/day strb rotate (live20_35, 116,372)
  R64 NE 2-tile water+fert (live20_36, 119,347)
  R68 NE packed crop walk, fert at the stop (live20_40, 123,726)
  R69 SW packed crop walk, tick fert (live20_41, 125,379)

Solo 6-seed AVG 125,379 vs v31 101,682. Stdlib-only, no file I/O.
"""
