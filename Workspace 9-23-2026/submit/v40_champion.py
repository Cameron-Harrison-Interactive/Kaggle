...
# R96 KEEP on 67. Hold wool when quote < floor (no denial dump of
# a dead market). No sheep buys if wool < $80. ep 110064585.
# vs-pass = 67 (138720). H2H vs 41 11-1 median +14276.
    ...
    if day <= 18 and not final_day:
        ...
        for kind in ("GOOSE", "COW", "SHEEP"):
            ...
            if kind == "SHEEP" and quoted("WOOL") < 80:
                continue
            if kind == "COW" and quoted("MILK") < 50 and quoted("FERTILIZER") < 25:
                continue
