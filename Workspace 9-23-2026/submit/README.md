...
## LIVE (on the ladder)
- `v33_champion.py` — ref 56283041 PENDING (09-16 16:19 UTC). war/astra_live20_51.py
  R79: 8 strawberries then SW/SE carrot + melon/wheat. H2H **9-3** vs v32.
  Solo 101,894. Latest-2 with v32. 3 remaining today after this post.
- `v32_champion.py` — ref 56270328 COMPLETE 684.6. war/astra_live20_41.py
  R69 KEEP: NW scripted animals + NE/SW packed crop walks. Solo **125,379**.
- `v31_champion.py` — built, never posted (R53a +370, not a win).
- `v30_champion.py` — ref 56262741 (v29 + R52 WORKER FIX: merged animal sweep (one traversal instead of two; feed stays a guaranteed prefix) + work-aware crew floor min(13,max(4,(25*quads+animals)//5)) that stops the crew-collapse death spiral. Solo 6-seed 101,312 (+3,418); vs v21 3-7 -> 6-4. 09-15)
...
Dev line: `war/astra_live20_15_c13.py` = v30 (LINE BEST, = submit/v30_champion.py),
`war/astra_live20_10.py` = v29 (fallback), `war/astra_live20_1.py` = v22 chassis,
