...
# R97 KEEP on 71. Factory through d22 while straw pays (was d15).
# Cow buy skipped if milk < $80 (same as wool). vs-pass 139239
# (+520 vs 67). H2H vs 41 12-0 median +15527. vs 71 6-6 wash.
...
def agent(obs, configuration=None):
    ...
    if opp_strb >= 30 and quoted("STRAWBERRY") < 160:
        ...
        strb_target = 8
        # d15 used to kill the factory while straw was still $200
        # (v40 losses: 33 -> weeds, they hold 40 through d24).
        # Carrot endgame is d23. Think until then.
