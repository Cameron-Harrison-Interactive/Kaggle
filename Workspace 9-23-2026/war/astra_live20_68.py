...
# R94c one-less-late-hire micro on v37. Cap crew 13 not 14
# (desired_hands 12). FIB 21 tail is the expensive body.
# Opening/herd/land/SE untouched.
...
def agent(obs, configuration=None):
    ...
    desired_hands = max(3, min(12, int(state.get("crew", 1)) - 1))
    if day <= 1:
