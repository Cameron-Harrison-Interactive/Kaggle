...
def agent(obs, configuration=None):
    ...
    if war:
        ...
        # R82: market first. 8 berries while the quote is junk
        # (seed does not pay under ~$100). If town is paying
        # (>= $180) lean back into the 33-tile factory. War/match
        # vs a 30+ berry opponent unchanged.
        strb_target = 33 if quoted("STRAWBERRY") >= 180 else 8
