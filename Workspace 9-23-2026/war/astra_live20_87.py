...
# R111 KEEP. Yarn + wool>=160 -> 8 sheep (not 10). Extra cow
# only if milk>=160. vs-pass 137452 (+820). H2H vs 65 12-0
# (s202 flipped). vs 41 12-0. vs 78 12-0. NEXT SUBMIT.
...
def agent(obs, configuration=None):
    ...
    targets = {
        ...
        "COW": min(6, day + 2) + (
            1 if n_milk_shop and "SW" in owned and quoted("MILK") >= 160 else 0),
