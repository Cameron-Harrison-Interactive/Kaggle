...
# R138. Berry row is y=2 (opens onto NE packed). Melon is y=0-1.
# Animals stay packed-6 on y=3,4. No leftover berries on the
# melon rows. Same walks. Do not submit.
...
def agent(obs, configuration=None):
    ...
    def plan_crop_choice(vseeds, filler=False, quad=None, pos=None):
        ...
        if quad == "NW" and not war:
            # R138: y=2 is the berry row (shed-adjacent east, then
            # into NE). y=0-1 is melon then wheat. Animals y=3-4.
