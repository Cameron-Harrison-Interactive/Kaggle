...
def agent(obs, configuration=None):
    ...
    if opp_strb >= 30:
        # Ladder: matching their 33-45 makes US the bigger dumper.
        # Straw went $30-$37 in the v34 losses. Stay small, take wheat.
        strb_target = 8
        if n_strb_shop >= 2 and quoted("STRAWBERRY") >= 180:
            strb_target = 16
    else:
        strb_target = 8
