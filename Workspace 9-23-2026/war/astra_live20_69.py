...
# R95 leak-fix on 67: fert-skip only d8-20 while the factory is
# alive. 67 skipped wheat sprays all game (straw stays $160+),
# d29 weeds 34 vs 24. Then wheat again after d20.
        ...
        for q in quads:
            ...
            if q == "NE":
                ...
                for si, wi in enumerate(wr[:len(_use)]):
                    ...
                    if not (quoted("STRAWBERRY") >= 160 and 8 <= day <= 20):
                        for _p in band:
            ...
            for bi, wi in enumerate(wr):
                ...
                if quoted("STRAWBERRY") >= 160 and 8 <= day <= 20:
