...
# R122 KEEP. Majkel-shaped factory, OUR later route. 1-shop
# 24 not 16. NW leftover crop after 12 melon is berries.
# fert_keep + tick-spray NW berries. Extra cow if milk shop
# + quote>=160 (no SW wait). Berry pace 6 before NE, land
# $1150 stays. vs-pass 138590 (+1138). 12-0 vs 87/65/41/67.
# 10-2 vs 78 s5-269. Do not submit.
