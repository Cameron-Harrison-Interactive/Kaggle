...
def agent(obs, configuration=None):
    ...
    if war:
        ...
        # R77: strawberry dump math. Linear crash: +11 sold over I0
        # and price is under the $100 seed; +62 is $1. One plant from
        # d10 yields ~5-6 units (first pick d20, tick every 2 days).
        # 16 plants ~= one field's T=100 if shops drain some. Extra
        # tiles go wheat/carrot (wheat +400 still $20). War/match
        # vs a 30+ berry opponent is unchanged.
        strb_target = 16
