...
def agent(obs, configuration=None):
    ...
    if day >= 2 and not final_day:
        # live8/live12 measured: the flat 12-cap plus horizon-dead seeds
        # (strb after d16, melon after d19) froze the stock while tiles sat
        # empty. Crew-scaled cap; only seeds a live crop_score would still
        # sow count toward the stock.
        standing_seeds = sum(
    ...
    try:
        with open("/tmp/astra_econ13.txt", "a") as _lf:
            _lf.write(
