...
VARIANTS = [
    ('W9 base (batch60,p1.0)', {}),
    ('batch30', {'wheat_batch': 30}),
    ('batch90', {'wheat_batch': 90}),
    ('batch150', {'wheat_batch': 150}),
    ('start72', {'wheat_start_step': 72}),
    ('cash1000', {'wheat_cash_reserve': 1000}),
    ('horizon4', {'investment_horizon': 4}),
    ('hold8', {'max_hold_steps': 8}),
    ('feed1.0', {'feed_days_reserve': 1.0}),
    ('mirror12', {'mirror_wheat_minimum_profit': 12}),
]
